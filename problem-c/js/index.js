...
lostGames.forEach(function(game) {
  ...
  console.log(opponent + " at UW, " + game.opponent_score + " to " + game.home_score);
});
...
function makeCombinedFilter(filterFunc1, filterFunc2) {
  function combinedFilter(game) {
    return filterFunc1(game) && filterFunc2(game);
  }
...
let lostWithFumbled = huskyGames2016.filter(fumbledAndLostFilter);
console.log(lostWithFumbled);
